      ...
      <form className="space-y-4" onSubmit={handleSubmit}>
        <div className="space-y-4">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              <label htmlFor="first-name" className="block text-sm font-medium text-primary-900 mb-1">
                First Name
              </label>
              <input
                id="first-name"
            ...
            <div>
              <label htmlFor="last-name" className="block text-sm font-medium text-primary-900 mb-1">
                Last Name
              </label>
              <input
                id="last-name"
          ...
          <div>
            <label htmlFor="confirm-password" className="block text-sm font-medium text-primary-900 mb-1">
              Confirm Password
            </label>
            <div className="relative">
              <input
